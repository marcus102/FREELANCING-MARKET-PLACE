        ...
        <div className="p-4 md:p-0 container text-center md:text-left m-auto flex justify-between items-center text-gray-700">
          ...
          <div className="flex md:hidden">
            <ul className="flex items-center">
              <Link
                className="text-gray-300 hover:text-green-400 text-lg font-bold py-4 px-6"
                href="/"
              >
                Home
              </Link>
          ...
          <ul className="hidden md:flex items-center  text-base font-semibold text-white cursor-pointer">
            <Link
              className="hover:text-green-400 text-lg font-bold py-4 px-6"
              href="/"
            >
              Home
            </Link>
            <Link
              className="hover:text-green-400 text-lg font-bold py-4"
              href="/profile"
            >
              Profile
            </Link>
