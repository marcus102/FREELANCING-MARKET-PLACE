  ...
  const data = [
    {
      ...
      answer:
        'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam aperiam esse enim tempore quaerat, porro perferendis reiciendis facilis, optio, harum nulla adipisci dignissimos! Totam commodi ipsam officia dolor eum repudiandae!',
    },
    {
      question: 'This is a new question for users!',
      answer:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
          ...
          <div>
            <div onClick={handleOpen} style={videoSideStyle}>
              <span className="how_works_play_button">
                <BsFillPlayFill />
              </span>
            </div>
            <div>
