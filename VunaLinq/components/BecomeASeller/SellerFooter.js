...
const SellerFooter = () => {
  ...
  return (
    <section className="footer text-white">
      <div className="row_footer container-fluid mx-auto">
        <div className="col_footer">
          <img
            ...
            src="https://i.ibb.co/Ssxh3cj/logo-white.png"
            alt=""
          />
          <p>
            Workfleek - Top Freelancer Marketplace WordPress Theme Dotem eiusmod
            tempor incune utnaem labore etdolore maignaiqua enim poskina ilukita
            ylokem lokateise ination voluptate velit ecillum dolore eu fugiat
            nulla pariatur lokaim urianewce more and more...
          </p>
        </div>
        <div className="col_footer">
      ...
      <hr />
      <p className="copyright container_fluid">
        Freelance Marketplace team &copy;2022{' '}
      </p>
    </section>
  )
}
